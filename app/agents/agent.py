...
input_text = "You are a SEO agent validate the metadata from DB then flag the issues after that generate the titles and keywords for those outdated and low score titles and keywords after that insert those data in DB."
